...
// Manager.cpp: определяет поведение классов для приложения.
//
...
// Создание CManagerApp

CManagerApp::CManagerApp() noexcept
{
...
// Единственный объект CManagerApp

CManagerApp theApp;


// Инициализация CManagerApp
...
// Обработчики сообщений CManagerApp
...
// Методы загрузки или сохранения настроек CManagerApp
